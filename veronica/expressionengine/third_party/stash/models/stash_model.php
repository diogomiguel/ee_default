...
class Stash_model extends CI_Model {
    ...
    function __construct()
    {
        ...
        $this->EE = get_instance();
				...
				//ADDED DIOGO ALLOW IE CACHE and NO Cookies bar
				if($this->EE->config->_global_vars['global:country_abbr'] == 'ie') {
					$this->_static_file .= '-ie';
				}
				
				if (!$this->EE->input->cookie('cookies_allowed')){
					$this->_static_file .= '-nocookies';
				}
				$this->_static_file .= '.html';
