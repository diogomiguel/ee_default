...
class Ep_better_workflow_acc {
	...
	{
		if($this->EE->input->get('C') == 'content_edit') 
		{
			$ajax_endpoint = str_replace('&C=javascript&M=load&file=ext_scripts', '&C=content_edit', $_SERVER['REQUEST_URI'])."&ep_bwf_getEntryInfo";
			...
			// <![CDATA[
			jQuery( function ($) {
				var ajaxEndPoint = \''.$ajax_endpoint.'\';
